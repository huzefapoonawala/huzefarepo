(function() {
	...
	require(["dojo",
		...
		dijit.byId('deleteItemsButton').attr({
			onClick: dojo.partial(manageItemSync,'../json/Item_deactivateItems.action',
					'Kindly select atleast one item to delete',
					'Are you sure, you want to delete selected items.',
					'Items deleted successfully.',
					dojo.partial(manageItemGrid,'../json/WebsiteProductsManager_fetchItemsToDeleteAfterSync.action',manageItemsForDeleteButton), false) 
		});
		...
		dijit.byId('item2DeleteButton').attr({
			onClick: dojo.partial(manageItemGrid,'../json/WebsiteProductsManager_fetchItemsToDeleteAfterSync.action',manageItemsForDeleteButton)
		});
