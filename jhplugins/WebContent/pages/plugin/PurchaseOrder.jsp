...
<div id="poForm" style="width: 100%" data-dojo-type="dijit.form.Form" data-dojo-props="method:'post'">
	<div id="formTable" data-dojo-type="dojox.layout.TableContainer" data-dojo-props="cols:3,orientation:'vert',showLabels:true">
		...
		<div data-dojo-type="dijit.form.Select" id="retailPriceColumn" data-dojo-props="label:'Retail Price Column', name:'retailPriceColumn', options:[{value:'suggestedRetail',label:'Catalog Retail'}, {value:'benchmarkRetail',label:'Benchmark Retail', selected:true}, {value:'proBenchmarkRetail',label:'Pro Benchmark Retail'}]"></div>
