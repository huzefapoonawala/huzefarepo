...
<script type="text/javascript">
	require(['js/plugin/OrgillItemSync']);
</script>
</head>
<body>
<form id="uploadForm" style="width: 100%; visibility: hidden;" data-dojo-type="dijit.form.Form" method="post" enctype="multipart/form-data">
	...
	<table>
		...
		<tr>
			<td>Step 4:</td>
			<td colspan="3">
				<div data-dojo-type="dijit.form.Button" id="item2DeleteButton" data-dojo-props="type:'button',label:'Show Items To Delete'"></div>
				&nbsp;&nbsp;&nbsp;
				<div data-dojo-type="dijit.form.Button" id="item2AddButton" data-dojo-props="type:'button',label:'Show Items To Add'"></div>
			</td>
		</tr>
	</table>
	<br>
...
<form id="manageForm" style="width: 100%; display: none;" data-dojo-type="dijit.form.Form" >
	...
	<div id="dataGrid"></div>
	<div align="center">
		<div data-dojo-type="dijit.form.Button" id="deleteItemsButton" data-dojo-props="label:'Delete Selected Items',type:'button'" style="display: none;"></div>
