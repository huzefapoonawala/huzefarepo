 ...
 *       &lt;sequence>
 *         &lt;element ref="{}interchange" maxOccurs="unbounded"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
@XmlRootElement(name = "ediroot810")
public class Ediroot810 {

    @XmlElement(required = true)
    protected List<Interchange> interchange;
    ...
    public List<Interchange> getInterchange() {
        if (interchange == null) {
            interchange = new ArrayList<Interchange>();
        }
